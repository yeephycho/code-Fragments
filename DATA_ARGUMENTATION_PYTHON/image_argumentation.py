...
image = cv2.imread("/home/yeephycho/Desktop/lennon-1.jpg")
print image.shape
#crop_image = crop_center_square(image)
crop_image = crop_square(image, 100)
print crop_image.shape
cv2.imwrite("/home/yeephycho/Desktop/cat_square.jpg", crop_image)
rsz_image = cv2.resize(crop_image, (256, 256))
print rsz_image.shape
cv2.imwrite("/home/yeephycho/Desktop/rsz_image.jpg", rsz_image)

rsz_image2 = cv2.resize(crop_image, (20, 20))
cv2.imwrite("/home/yeephycho/Desktop/small_image.jpg", rsz_image2)
